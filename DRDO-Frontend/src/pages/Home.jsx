  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow relative w-full h-[calc(100vh-150px)] bg-gradient-to-r from-[#02447C] to-[#046BA4] text-white flex flex-col items-center justify-center text-center shadow-md px-4">
        <h2 className="text-4xl font-bold mb-4">Welcome to DRDO - SSPL Grant-In-Aid Portal</h2>
        <p className="text-lg text-blue-100 mb-6">Securely manage and view Conference / Seminar grant records</p>
